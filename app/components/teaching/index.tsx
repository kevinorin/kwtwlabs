  ...
  return (
    <section id="teachingSection" className="snap-start min-h-screen flex flex-col justify-center items-center bg-gradient-to-tl from-secondary to-primary text-black p-5">
      ...
      > <h2 className="text-2xl font-semibold pt-5 mb-4">Documentating & Online Training</h2>
        ...
        <p className="mb-4 text-lg">I&rsquo;m generally introverted, but not when it comes to public speaking. I&rsquo;ve performed in a theatrical drama for thousands and addressed audiences of over 200 individuals. I&rsquo;ve honed my ability to engage and captivate diverse groups. My approach is simple: Preparation, knowing the subject matter well enough to pivot, and...acting. Yes, for someone introverted like me, confident public speaking is essentially an act of performing.🎭</p>
