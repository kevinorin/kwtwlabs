  ...
  return (
    <section id="outroSection" className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-primary to-secondary text-black p-5 max-w-4xl mx-auto">
      ...
      >
        ...
        <p className="text-lg mb-8">With a strong foundation in frontend and backend development as well as UI/UX, a knack for prototyping with the latest tech, and a love for experimenting, I&rsquo;m eager to bring my blend of creativity and technical skill to your digital agency.</p>
        <p className="text-lg mb-8">This application is a testament to my readiness to contribute to and grow with your team, embracing every challenge and opportunity.
        </p>
